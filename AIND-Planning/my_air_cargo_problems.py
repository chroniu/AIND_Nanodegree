...
class AirCargoProblem(Problem):
    ...
    def result(self, state: str, action: Action):
        ...
        #    raise Exception("Action not in actions list")
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        # the minimum number of actions is equal to the number of goal
        # claures not satisfied in node.state
        # modifing the code of goal_test
